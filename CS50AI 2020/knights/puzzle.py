...
knowledge0 = And(
    # TODO
    Not(And(AKnight, AKnave)), #can't be knight and knave same time
    Or(AKnight, AKnave),
...
knowledge1 = And(
    ...
    Not(And(AKnight, AKnave)), #can't be knight and knave same time
    Or(AKnight, AKnave),
    Not(And(BKnight, BKnave)), #can't be knight and knave same time
    Or(BKnight, BKnave), 
...
knowledge3 = And(
    ...
    Not(And(BKnight, BKnave)), #can't be knight and knave same time
    Or(BKnight, BKnave),
    Not(And(CKnight, CKnave)), #can't be knight and knave same time
    Or(CKnight, CKnave),
